...
const CORE_TOOL_DEFINITIONS: CoreToolDefinition[] = [
  ...
  },
  {
    id: "memory_search",
    label: "memory_search",
    description: "Search remembered user facts",
    sectionId: "memory",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
  {
    id: "memory_get",
    label: "memory_get",
    description: "Read user memory facts",
    sectionId: "memory",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
  {
    ...
    description: "Search saved docs and knowledge",
    sectionId: "memory",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
  {
    id: "knowledge_get",
    label: "knowledge_get",
    description: "Read saved docs and knowledge",
    sectionId: "memory",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
  {
    id: "history_search",
    label: "history_search",
    description: "Search prior chat history",
    sectionId: "memory",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
  {
    id: "history_get",
    label: "history_get",
    description: "Read prior chat history",
    sectionId: "memory",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
