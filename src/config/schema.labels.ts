...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "cron.httpAction": "Cron HTTP Action",
  "cron.httpAction.allowPrivateNetwork": "Cron HTTP Action Allow Private Network",
  "cron.httpAction.allowedHostnames": "Cron HTTP Action Allowed Hostnames",
  "cron.httpAction.hostnameAllowlist": "Cron HTTP Action Hostname Allowlist",
